...
6.Download the freetype library here
Unpack, build and copy to the appropriate directory.
cd freetype-2.4.12
./configure --build=i686-pc-linux-gnu "CFLAGS=-m32" "CXXFLAGS=-m32" "LDFLAGS=-m32"
make -j8
mkdir modelsim_ase/lib32
sudo cp freetype-2.4.12/objs/.libs/libfreetype.so* modelsim_ase/lib32
Open .bashrc to add the binaries to your path:
nano ~/.bashrc
Paste the following at the bottom, where you replace the ALTERAPATH to your quartus installation directory. Restart the terminal when you have saved the file.
# Quartus
...
Re-open your terminal and edit your binary vsim launch file (if you are unsure where this is located type which vsim)
...
You should now be able to launch quartus by typing quartus and ModelSIM can be launched with vsim
For simulations it is very handy to add the grlib library to your path as well:

Download grlib here
nano ~/.bashrc
Paste the following at the bottom of that file, replace the path to your installation of the grlib library.
